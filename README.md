...
A user subroutine implementation composed of DFLUX, UEPACTIVATIONVOL, and ORIENT is provided in this module, which simulates the heat input, element activation, and nodal temperature extraction for the WAAM process of a multi-layer wall. 
...
## Request Access
If you'd like access to the private version of this code, please open an [Issue](../../issues/new?template=access-request.md) (or send me an email at behsaeed@nmsu.edu) describing your request.
